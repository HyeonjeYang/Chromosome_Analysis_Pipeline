...
def add_confinement(sim, polymer_force_conf, density, k, r):
    if polymer_force_conf == "spherical_confinement":
        ...
        sim.add_force(forces.cylindrical_confinement(sim, k=k, bottom = 0, top=100, r=r))
...
trunc = 5.0 #if low, then topoisomerase-like, if high, then no strand crossing
...
block_timesteps = 5 # ~ 100 integration steps
